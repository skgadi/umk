...
sre.Cli.prototype.commandLine=function(){var a=sre.SystemExternal.commander,b=this.system,c=goog.bind(function(a){return goog.bind(function(b,c){this.set(a,b,c)},this)},this),d=goog.bind(this.processor,this);a.version(b.version).usage("[options] <file ...>").option("").option("-i, --input [name]","Input file [name]. (Deprecated)").option("-o, --output [name]","Output file [name]. Defaults to stdout.").option("").option("-d, --domain [name]","Speech rule set [name]. See --options for details.",c(sre.DynamicCstr.Axis.DOMAIN),
sre.DynamicCstr.DEFAULT_VALUES[sre.DynamicCstr.Axis.DOMAIN]).option("-t, --style [name]","Speech style [name]. See --options for details.",c(sre.DynamicCstr.Axis.STYLE),sre.DynamicCstr.DEFAULT_VALUES[sre.DynamicCstr.Axis.STYLE]).option("-c, --locale [code]","Locale [code].",c(sre.DynamicCstr.Axis.LOCALE),sre.DynamicCstr.DEFAULT_VALUES[sre.DynamicCstr.Axis.LOCALE]).option("-b, --modality [name]","Modality [name].",c(sre.DynamicCstr.Axis.MODALITY),sre.DynamicCstr.DEFAULT_VALUES[sre.DynamicCstr.Axis.MODALITY]).option("-s, --semantics",
"Switch OFF semantics interpretation. (Deprecated)",c("semantics")).option("-k, --markup [name]","Generate speech output with markup tags.",c("markup"),"none").option("-r, --rate [value]","Base rate [value] for tagged speech output.",c("rate"),"100").option("").option("-p, --speech","Generate speech output (default).",d,"speech").option("-a, --audit","Generate auditory descriptions (JSON format).",d,"description").option("-j, --json","Generate JSON of semantic tree.",d,"json").option("-x, --xml",
"Generate XML of semantic tree.",d,"semantic").option("").option("-m, --mathml","Generate enriched MathML.",d,"enriched").option("-g, --generate <depth>","Include generated speech in enriched MathML (with -m option only).",c("speech"),"none").option("-w, --structure","Include structure attribute in enriched MathML (with -m option only).",c,"structure").option("").option("-P, --pprint","Pretty print output whenever possible.",c("pprint")).option("-v, --verbose","Verbose mode.").option("-l, --log [name]",
"Log file [name].").option("--options","List engine setup options.").on("option:options",goog.bind(function(){this.enumerate();sre.SystemExternal.process.exit(0)},this)).parse(sre.SystemExternal.process.argv);this.system.setupEngine(this.setup);a.verbose&&sre.Debugger.getInstance().init(a.log);a.input&&this.execute(a.input);a.args.length?a.args.forEach(goog.bind(this.execute,this)):this.readline();sre.Debugger.getInstance().exit(function(){sre.SystemExternal.process.exit(0)})};
sre.SystemExternal.process&&sre.SystemExternal.process.env.SRE_TOP_PATH&&(new sre.Cli).commandLine();sre.Api={};module.exports.version=sre.System.getInstance().version;module.exports.toSpeech=sre.System.getInstance().toSpeech;module.exports.toSemantic=sre.System.getInstance().toSemantic;module.exports.toJson=sre.System.getInstance().toJson;module.exports.toDescription=sre.System.getInstance().toDescription;module.exports.toEnriched=sre.System.getInstance().toEnriched;module.exports.walk=sre.System.getInstance().walk;module.exports.move=sre.System.getInstance().move;module.exports.file={};
