...
function findFields(locale) {
    ...
    var parentHierarchy = intl_utils_1.getParentLocaleHierarchy(locale);
...
var RelativeTimeFormat = /** @class */ (function () {
    function RelativeTimeFormat() {
        ...
        var resolvedLocale = intl_utils_1.findSupportedLocale(localesToLookup, RelativeTimeFormat.__localeData__);
        if (!resolvedLocale) {
        ...
        this._localeMatcher = intl_utils_1.getOption(opts, 'localeMatcher', 'string', ['best fit', 'lookup'], 'best fit');
        this._style = intl_utils_1.getOption(opts, 'style', 'string', ['long', 'narrow', 'short'], 'long');
        this._numeric = intl_utils_1.getOption(opts, 'numeric', 'string', ['always', 'auto'], 'always');
