class umk_1595491915152 extends umk_model {
    Icon() {
      return {
        ...
        html: '<div class="sink-btns"><button onClick="popup.open(event,\'ball\',false)" style="padding:0;"><i class="far fa-window-restore fa-fw"></i></button><button onClick="popup.open(event,\'ball\')" class="pointer" style="padding:0;"><i class="fas fa-external-link-alt fa-fw"></i></button></div>',
