(function (factory) {
    ...
    function findFields(locale) {
        ...
        dataToMerge.reverse();
        return dataToMerge.reduce(function (all, d) { return (__assign$1(__assign$1({}, all), d.fields)); }, {});
    }
